  ...
  let modulesConfigs = {
    ...
    Pages: {
      ...
      fileName: {
        ...
        transfer: { key: 'transfer', text: '中转页' }
      }
    },
    // 中转页
    PagesTransfer: {
    ...
    PagesRecharge: {
      ...
      route: true,
      fileName: {
        index: { key: 'index', text: '收银台-充值' },
        offlineRecharge: { key: 'offline-recharge', text: '线下充值' }
      }
    },
    // 二维码收款
    PagesQRCodeCollection: {
      path: 'pages/qrcode-collection/',
      route: true,
      fileName: {
        index: { key: 'index', text: '二维码收款' }
      }
    },
    // 转账
    PagesTransferAccounts: {
      path: 'pages/transfer-accounts/',
      route: true,
      fileName: {
        index: { key: 'index', text: '转账-首页' },
        transferAccount: { key: 'transfer-account', text: '转到余额账户' },
        transferHistoryMember: { key: 'transfer-history-member', text: '历史收款人' },
        transferAccountPay: { key: 'transfer-account-pay', text: '转账支付' }
      }
    },
    // 提现
    PagesWithdrawal: {
      ...
      route: true,
      fileName: {
        index: { key: 'index', text: '提现-首页' },
        setLoginInfo: { key: 'set-login-info', text: '设置登录信息' },
        withdrawalPay: { key: 'withdrawal-pay', text: '提现支付' }
      }
    },
    // 交易
    PagesTransaction: {
      ...
      route: true,
      fileName: {
        index: { key: 'index', text: '交易-首页' },
        surplusPay: { key: 'surplus-pay', text: '余额支付' },
        // 支付宝交易结果
        zfbResult: { key: 'zfb-result', text: '支付宝交易结果页' },
        // 重置支付密码
        resetPwdFirstStep: { key: 'resetpwd-firststep', text: '重置支付密码1' },
        resetPwdSecondStep: { key: 'resetpwd-secondstep', text: '重置支付密码2' },
        resetPwdThirdStep: { key: 'resetpwd-thirdstep', text: '重置支付密码3' },
        setLoginInfo: { key: 'set-login-info', text: '设置登录信息' }
      }
    },
    // 公共页面
    ...
    PagesLayout: {
      ...
      fileName: {
        ...
        recharge: 'recharge',
        // 二维码收款
        qrcodeCollection: 'qrcode-collection',
        // 转账
    ...
    Services: {
      ...
      fileName: {
        ...
        payPswService: 'paypsw.service.js',
        rechargeService: 'recharge.service.js',
        transferAccountsService: 'transfer-accounts.service.js',
        placeCardPayService: 'place-cardpay.service.js',
        tradepayService: 'tradepay.service.js'
      }
    },
    // vuex store
    Store: { path: 'store/' },
